...
export const panelAdmin = asyncHandler(async (req, res) => {
  res.json(await stats.panelAdmin(req.repositorio, req.usuario));
});

export const informes = asyncHandler(async (req, res) => {
  res.json(await stats.informes(req.repositorio, req.usuario));
});

export const exportacion = asyncHandler(async (req, res) => {
  res.json(await stats.exportacion(req.repositorio, req.usuario));
});
